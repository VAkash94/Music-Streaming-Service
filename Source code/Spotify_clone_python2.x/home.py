...
class Home:
    ...
    def last_played(self):
        ...
        print(description)
        user_input = raw_input("Enter song number to play or 'back' go to home\n")
    ...
    def currently_playing(self):
        ...
        print(description)
        user_input = raw_input("Enter 'back' go to home\n")
        while user_input != 'back':
            user_input = raw_input("Enter 'back' go to home\n")
    ...
    def search(self):
        ...
        user_input = raw_input("Enter the search string......\n")
        song_list = search_song.get_songs(user_input)
        if len(song_list) == 0:
            user_input = raw_input("No songs found.....\nDo you want to search again [Y/n]\n")
    ...
    def display_songs(self, disply, song_list):
        ...
        for song in song_list:
            ...
            disply += description + "\n"
            count += 1
        user_input = raw_input("Enter song number to play, 'add song number' to add songs to playlist or 'back' go to home\n")
        while user_input != 'back':
            ...
            print(disply)
            user_input = raw_input("Enter song number to play, 'add song number' to add songs to playlist or 'back' "
                                   "go to home\n")